#' Compute BEAM p-values for sets
#'
...
#'
#' @return A list with a data.frame of set p-values from BEAM analysis, a data.frame of summary row p-values, and a data frame of set matching.
